...
QuantClaw is built on four opinions, in priority order.
...
- **Not a framework.** You don't build apps on top of QuantClaw. You configure it and connect channels.
