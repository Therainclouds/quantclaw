...
| `zeroclaw` | Operating the running QuantClaw instance (CLI + gateway API) |
...
QuantClaw uses squash-merge for all PRs. The `squash-merge` skill produces both the purple **Merged** badge *and* a conventional-commits formatted squash message with full commit history in the body.
